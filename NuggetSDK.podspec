Pod::Spec.new do |s|
  ...
  s.prepare_command = <<-CMD
    ...
    curl -L https://github.com/kishansoni-cmd/nugget-sdk-ios/releases/download/test-4.5.36/Nugget.xcframework.zip -o Nugget.xcframework.zip
    verify_checksum "Nugget.xcframework.zip" "e50b465e484e652f04c64cf87d417a67ff48f6d66a1f4bd0e239734f580e5d69"
